...
document.addEventListener("DOMContentLoaded", function () {
    ...
    function checkBoard() {
        ...
        for (var j = 0; j < winningArrays.length; j++) {
            var square1 = squares[winningArrays[j][0]];
            var square2 = squares[winningArrays[j][1]];
            var square3 = squares[winningArrays[j][2]];
            var square4 = squares[winningArrays[j][3]];
    ...
    squares.forEach(function (square) { return square.addEventListener("mouseout", checkBoard); });
